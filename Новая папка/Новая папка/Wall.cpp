...
Wall::Wall(std::shared_ptr<Vector2d> vec, std::shared_ptr<Rectangle> rect)
{
	Velocity(0, 0);
...
Wall::Wall(int x, int y, std::shared_ptr<Rectangle> rect)
{
	Velocity(0, 0);
...
Wall::Wall(int x, int y, std::shared_ptr< Texture > text)
{
	Velocity(0, 0);
	std::cout << "PL S" << std::endl;
	setSkin( text, tWall );
...
Wall::Wall(std::shared_ptr<Vector2d> vec, Rectangle & rect)
{
}
